<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-40">
    ...
    <div class="flex items-center justify-center mt-8">
      ...
      >
        <Markdown :use="$scopedSlots.secondaryCta" unwrap="span" />
      </SectionButton>
    </div>
  </div>
</template>
